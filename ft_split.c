...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/07 14:07:55 by adarmoya          #+#    #+#             */
/*   Updated: 2026/02/09 14:40:31 by adarmoya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// int	main(void)
// {
// 	char	*s = "wdrhdsrrrdalllsrq";
// 	int	i = 0;
// 	int	size = count_words(s, 0);
// 	printf("%d\n", size);
// 	char	**array = ft_split(s, 0);
// //	while (array[i])
// //	{
// 		printf("%s\n", array[0]);
// //		i++;
